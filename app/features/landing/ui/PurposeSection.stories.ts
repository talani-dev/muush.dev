  ...
  nodes: [
    {
      ...
      index: 0 as const,
      label: 'Why',
      copy: 'El software rara vez falla por cómo se construye. Falla porque nadie tradujo el problema de negocio; saber qué vale la pena construir es lo que cambia el resultado.',
    },
    {
      id: 'how' as const,
      index: 1 as const,
      label: 'How',
      copy: 'Primero entendemos tu operación, después decidimos qué se construye. Traducimos antes de construir.',
    },
    {
      id: 'what' as const,
      index: 2 as const,
      label: 'What',
      copy: 'Diseñamos y construimos soluciones digitales que tu negocio usa todos los días.',
    },
  ],
}
  ...
  nodes: [
    {
      ...
      index: 0 as const,
      label: 'Why',
      copy: "Software rarely fails because of how it's built. It fails because nobody translated the business problem; knowing what's worth building is what changes the outcome.",
    },
    {
      id: 'how' as const,
      index: 1 as const,
      label: 'How',
      copy: 'First, we understand how you operate; then we decide what gets built. We translate before we build.',
    },
    {
      id: 'what' as const,
      index: 2 as const,
      label: 'What',
      copy: 'We design and build digital solutions your business uses every day.',
    },
  ],
}
